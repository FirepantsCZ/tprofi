...
def get_mesic_narozeni():
	...
	mesic_narozeni = random.randint(1,12)
...
def get_den_narozeni(mesic_narozeni):
	...
	den_narozeni = random.randint(1,posledni_den)
...
def get_email(jmeno,prijmeni,rok):
	...
	if nahoda_alias == 0:
		alias = str(jmeno) + '.' + str(prijmeni)
	elif nahoda_alias == 1:
		alias = str(jmeno) + str(jmeno)
	elif nahoda_alias == 2:
		alias = str(jmeno) + rok
	elif nahoda_alias == 3:
		alias = str(jmeno) + '.' + rok
		...
		alias = str(jmeno) + str(prijmeni[0])
	elif nahoda_alias == 7:
		alias = str(jmeno[0]) + str(jmeno)
	elif nahoda_alias == 8:
		alias = str(jmeno) + '.' + str(prijmeni[0])
	elif nahoda_alias == 9:
		alias = str(jmeno[0]) + '.' + str(jmeno)
	elif nahoda_alias == 11:
		alias = str(jmeno) + '.' + str(jmeno) + rok
